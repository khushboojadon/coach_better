...
class EventsViewAdmin extends StatefulWidget {
  @override
  State createState() {
    return EventsViewAdminState();
  }
}

class EventsViewAdminState extends State<EventsViewAdmin> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
                                                            ...
                                                            child: Row(
                                                              children: <
                                                                ...
                                                                Text(
                                                                  ...
                                                                  //   .data[index]
                                                                  //   .available
                                                                  training[index]['available'].toString()
                                                                    ),
                                                                SizedBox(
                                                                    width:
                                                                        10.0),
                                                          ...
                                                          child: Row(
                                                            children: <Widget>[
                                                              ...
                                                              Text(
                                                                ...
                                                                //   .data[index]
                                                                //   .not_available
                                                                training[index]['not_available'].toString()
                                                                  ),
                                                              SizedBox(
                                                                  width: 10.0),
                                                              Text(
